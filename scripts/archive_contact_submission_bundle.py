#!/usr/bin/env python3
"""Create a canonical ZIP and checksum from a ready contact-paper bundle."""
...
from contact_submission_archive import create_archive, write_checksum
...
def main() -> int:
    ...
    try:
        ...
        raise SystemExit(
            f"cannot archive contact submission bundle: {error}"
        ) from error
