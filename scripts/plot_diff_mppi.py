...
PLOT_ORDER = ["mppi", "feedback_mppi", "feedback_mppi_hf", "feedback_mppi_ref", "feedback_mppi_sens", "feedback_mppi_cov", "feedback_mppi_fused", "grad_only_3", "diff_mppi_1", "diff_mppi_3"]
SCENARIO_TITLES = {
