#!/usr/bin/env python3
"""Create and validate canonical anonymous contact-paper submission ZIPs."""
...
ARCHIVE_ROOT = "contact-rich-diff-mppi-submission"
...
def create_archive(
    ...
    if not gate["valid"] or not gate["ready"]:
        ...
        raise ValueError("submission bundle is not ready: " + ", ".join(failed))
