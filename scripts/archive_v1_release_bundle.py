#!/usr/bin/env python3
"""Create a canonical ZIP and SHA-256 sidecar from a v1 evidence bundle."""
...
from v1_release_archive import create_archive, write_checksum
...
def main() -> int:
    ...
    try:
        ...
        raise SystemExit(f"cannot archive v1 release bundle: {error}") from error
