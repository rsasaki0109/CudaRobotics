...
| Learning-based planning | `gpu_diffusion_planner`, `gpu_diffusion_policy`, `gpu_diff_value_iteration_traversability` | 512 x 64 trajectories / 192x128 soft VI | analytic score -> BC denoising policy; 747.4x learned-cost VI |
...
| **GPU differentiable value iteration traversability (192x128 learned cost, 220 soft Bellman iters, 747.4x vs CPU)** | |
| <img src="https://rsasaki0109.github.io/CudaRobotics/gpu_diff_value_iteration_traversability.gif" width="400"/> | |
