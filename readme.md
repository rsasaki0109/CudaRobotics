...
| Learning-based planning | `gpu_diffusion_planner`, `gpu_diffusion_policy`, `gpu_diff_value_iteration_traversability`, `gpu_neural_astar_traversability` | 512 x 64 trajectories / 192x128 soft VI / 64x neural A* | analytic score -> BC denoising policy; 747.4x learned-cost VI; 153.1x batched neural A* |
