...
// -------------------------------------------------------------------------
// Dijkstra search state (step-by-step for animation)
// -------------------------------------------------------------------------
struct SearchState {
    Node* nstart;
    Node* ngoal;
    ...
    SearchState(Node* start, Node* goal,
        ...
        : nstart(start), ngoal(goal),
          ...
          pq([](const Node* l, const Node* r) { return l->cost > r->cost; }),
...
// -------------------------------------------------------------------------
// Setup obstacles (same as original dijkstra.cpp)
// -------------------------------------------------------------------------
...
int main() {
    ...
    // Create search states for both (identical Dijkstra search)
    ...
    // Video setup
    cv::VideoWriter video("gif/comparison_dijkstra.avi",
    ...
    system("ffmpeg -y -i gif/comparison_dijkstra.avi "
           ...
           "gif/comparison_dijkstra.gif 2>/dev/null");
