...
honest boundary on tight-tolerance high-friction tasks; and a differentiability-vs-fidelity
...
\begin{enumerate}
  ...
  \item \textbf{A mechanism, a predictor, and external validity.} We show vanilla
    ...
    sharing one smooth model, with a stated high-friction boundary and a
...
states the boundary plainly: on a tight-tolerance task at high friction the
frictionless model is too wrong and the gradient fails. A full sim-to-\emph{real}
