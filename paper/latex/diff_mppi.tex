...
(Table~\ref{tab:mismatch_pivot}): vanilla MPPI never drops below $0.138$ (gain) or
...
de-risk this with the contact-model mismatch study
(Tables~\ref{tab:mismatch} and~\ref{tab:mismatch_pivot}), which shows the
advantage survives $\pm 30$--$40\%$ error in the plant's contact mobility and
$\pm 15\%$ error in the object dimensions on two distinct contact tasks, but a
full sim-to-real validation remains future work. The contact
