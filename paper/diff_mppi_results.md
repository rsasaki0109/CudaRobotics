...
A later dynamic-obstacle suite, exact matched-time tuning, gradient-only ablation, and strengthened in-repo feedback-baseline follow-up is recorded separately in `paper/diff_mppi_novelty_followup.md`.
