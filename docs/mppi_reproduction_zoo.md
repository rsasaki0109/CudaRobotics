...
- Box pushing checked-in row: [`results/soppi_box_pushing_2026-06-11.md`](results/soppi_box_pushing_2026-06-11.md)
  (`box_align_strict` added). Next engineering step is obstacle detours or contact-loss cells.
