...
| dwa_fast | DWA | 30 | 28 | 0.93 | 1.94 | 0.60 | 0.05 |
| dwa_fine | DWA | 30 | 30 | 1.00 | 1.92 | 0.00 | 0.06 |
| dwa_med | DWA | 30 | 30 | 1.00 | 1.91 | 0.00 | 0.05 |
| stomp_1 | STOMP | 30 | 17 | 0.57 | 5.97 | 0.00 | 0.48 |
| stomp_2 | STOMP | 30 | 17 | 0.59 | 2.86 | 0.00 | 0.94 |
| stomp_3_smooth | STOMP | 30 | 18 | 0.60 | 2.83 | 0.00 | 1.40 |
...
| stomp_1 | STOMP | 12 | 6 | 0.50 | 7.16 | 0.00 |
| stomp_2 | STOMP | 12 | 6 | 0.50 | 2.98 | 0.00 |
| stomp_3_smooth | STOMP | 12 | 6 | 0.50 | 2.94 | 0.00 |
...
|---|---|---|---|---|---|---|---|---|
| dynamic_crossing | +0.00 | 1.00 | diff_mppi_3_early8 | **1.00** | 1.85 | stomp_3_smooth | **1.00** | +0.03 |
| dynamic_crossing | +0.00 | 1.30 | diff_mppi_3_early8 | **1.00** | 1.85 | stomp_3_smooth | **1.00** | +0.03 |
| dynamic_crossing | +0.50 | 1.00 | diff_mppi_3_early8 | **1.00** | 1.85 | stomp_3_smooth | **1.00** | +0.03 |
| dynamic_crossing | +0.50 | 1.30 | diff_mppi_3_early8 | **1.00** | 1.85 | stomp_3_smooth | **1.00** | +0.03 |
...
| dynamic_crossing | +1.50 | 1.00 | dwa_fast | **1.00** | 1.80 | stomp_3_smooth | **1.00** | +0.07 |
...
| dynamic_crossing | +2.00 | 1.30 | diff_mppi_3 | **1.00** | 1.85 | dwa_fine | **1.00** | +0.02 |
| dynamic_pincer | +0.00 | 1.00 | diff_mppi_3_early8 | **1.00** | 1.85 | stomp_3_smooth | **1.00** | +0.03 |
...
| dynamic_pincer | +0.50 | 1.30 | diff_mppi_3_early8 | **1.00** | 1.83 | dwa_med | **1.00** | +0.04 |
...
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.97 | 1.97 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.92 | 1.92 | 0.01 |
...
| stomp_3_smooth | STOMP | **1.00** | 1.88 | 1.88 | 1.40 |
...
| stomp_1 | STOMP | **1.00** | 1.94 | 1.94 | 0.48 |
| stomp_2 | STOMP | **1.00** | 1.92 | 1.92 | 0.94 |
| stomp_3_smooth | STOMP | **1.00** | 1.88 | 1.88 | 1.39 |
| diff_mppi_3 | Diff-MPPI | **1.00** | 1.95 | 1.95 | 0.65 |
| diff_mppi_3_early8 | Diff-MPPI | **1.00** | 1.85 | 1.85 | 0.65 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.95 | 1.95 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.92 | 1.92 | 0.01 |
...
| stomp_3_smooth | STOMP | **1.00** | 1.96 | 1.96 | 1.40 |
| diff_mppi_3 | Diff-MPPI | **1.00** | 1.95 | 1.95 | 0.65 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.85 | 1.85 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.92 | 1.92 | 0.01 |
| dwa_fast | DWA | **1.00** | 1.82 | 1.82 | 0.05 |
| dwa_fine | DWA | **1.00** | 1.95 | 1.95 | 0.06 |
| dwa_med | DWA | **1.00** | 1.94 | 1.94 | 0.05 |
| stomp_1 | STOMP | **1.00** | 1.86 | 1.86 | 0.48 |
| stomp_2 | STOMP | **1.00** | 1.97 | 1.97 | 0.94 |
| stomp_3_smooth | STOMP | **1.00** | 1.96 | 1.96 | 1.39 |
| diff_mppi_3 | Diff-MPPI | **1.00** | 1.98 | 1.98 | 0.65 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.87 | 1.87 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | 0.00 | 1.92 | 1.92 | 0.01 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.84 | 1.84 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | 0.00 | 1.92 | 1.92 | 0.01 |
| dwa_fast | DWA | **1.00** | 1.92 | 1.92 | 0.04 |
| dwa_fine | DWA | **1.00** | 1.89 | 1.89 | 0.06 |
| dwa_med | DWA | **1.00** | 1.95 | 1.95 | 0.05 |
| stomp_1 | STOMP | **1.00** | 1.89 | 2.03 | 0.48 |
| stomp_2 | STOMP | **1.00** | 1.98 | 1.98 | 0.94 |
| stomp_3_smooth | STOMP | **1.00** | 1.95 | 1.95 | 1.40 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.89 | 1.89 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.92 | 1.92 | 0.01 |
| dwa_fast | DWA | **1.00** | 1.89 | 1.89 | 0.05 |
| dwa_fine | DWA | **1.00** | 1.88 | 1.88 | 0.06 |
| dwa_med | DWA | **1.00** | 1.90 | 1.90 | 0.05 |
| stomp_1 | STOMP | **1.00** | 1.89 | 1.89 | 0.48 |
| stomp_2 | STOMP | **1.00** | 1.97 | 1.97 | 0.94 |
| stomp_3_smooth | STOMP | **1.00** | 1.89 | 1.89 | 1.39 |
...
| stomp_3_smooth | STOMP | **1.00** | 1.95 | 1.95 | 1.41 |
| diff_mppi_3 | Diff-MPPI | **1.00** | 1.95 | 1.95 | 0.66 |
...
| stomp_1 | STOMP | **1.00** | 1.91 | 1.96 | 0.48 |
| stomp_2 | STOMP | **1.00** | 1.89 | 1.89 | 0.94 |
...
| stomp_1 | STOMP | 0.00 | 6.49 | 6.74 | 0.48 |
| stomp_2 | STOMP | 0.75 | 2.47 | 2.53 | 0.94 |
| stomp_3_smooth | STOMP | **1.00** | 1.98 | 1.98 | 1.41 |
...
| stomp_1 | STOMP | 0.00 | 3.04 | 3.27 | 0.48 |
| stomp_2 | STOMP | 0.00 | 2.45 | 2.63 | 0.94 |
| stomp_3_smooth | STOMP | 0.00 | 2.41 | 2.59 | 1.41 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.97 | 2.15 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | 0.00 | 1.92 | 1.92 | 0.01 |
| dwa_fast | DWA | 0.00 | 1.92 | 1.92 | 0.05 |
| dwa_fine | DWA | **1.00** | 1.97 | 1.97 | 0.06 |
| dwa_med | DWA | **1.00** | 1.99 | 2.17 | 0.06 |
| stomp_1 | STOMP | 0.00 | 27.56 | 27.62 | 0.48 |
| stomp_2 | STOMP | 0.00 | 4.02 | 4.26 | 0.94 |
| stomp_3_smooth | STOMP | 0.00 | 4.01 | 4.25 | 1.41 |
| diff_mppi_3 | Diff-MPPI | 0.00 | 10.66 | 10.91 | 0.66 |
| diff_mppi_3_early8 | Diff-MPPI | 0.00 | 4.54 | 4.79 | 0.67 |
...
| stomp_2 | STOMP | **1.00** | 1.99 | 1.99 | 0.95 |
| stomp_3_smooth | STOMP | **1.00** | 1.91 | 1.91 | 1.40 |
...
| stomp_1 | STOMP | **1.00** | 1.94 | 2.13 | 0.49 |
| stomp_2 | STOMP | **1.00** | 1.88 | 1.88 | 0.94 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.93 | 1.93 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.90 | 1.90 | 0.01 |
| dwa_fast | DWA | **1.00** | 1.90 | 1.90 | 0.05 |
| dwa_fine | DWA | **1.00** | 1.88 | 1.88 | 0.06 |
| dwa_med | DWA | **1.00** | 1.99 | 1.99 | 0.06 |
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.48 |
| stomp_2 | STOMP | 0.00 | 4.42 | 4.66 | 0.94 |
...
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.49 |
| stomp_2 | STOMP | 0.00 | 4.42 | 4.66 | 0.94 |
...
| planner | family | succ | final_d | min_d | ms |
|---|---|---|---|---|---|
| hybrid_astar_dwa | Hybrid-A* | **1.00** | 1.92 | 1.92 | 0.06 |
| hybrid_astar_pp | Hybrid-A* | **1.00** | 1.90 | 1.90 | 0.01 |
...
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.49 |
| stomp_2 | STOMP | 0.00 | 4.42 | 4.66 | 0.94 |
| stomp_3_smooth | STOMP | 0.00 | 4.40 | 4.64 | 1.41 |
| diff_mppi_3 | Diff-MPPI | **1.00** | 1.92 | 1.92 | 0.66 |
| diff_mppi_3_early8 | Diff-MPPI | **1.00** | 1.84 | 1.84 | 0.66 |
...
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.48 |
| stomp_2 | STOMP | 0.00 | 4.43 | 4.68 | 0.95 |
| stomp_3_smooth | STOMP | 0.00 | 4.37 | 4.61 | 1.41 |
...
| dwa_med | DWA | **1.00** | 1.83 | 1.83 | 0.06 |
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.49 |
| stomp_2 | STOMP | 0.00 | 4.45 | 4.70 | 0.95 |
| stomp_3_smooth | STOMP | 0.00 | 4.38 | 4.63 | 1.41 |
| diff_mppi_3 | Diff-MPPI | 0.00 | 2.56 | 2.79 | 0.66 |
| diff_mppi_3_early8 | Diff-MPPI | 0.00 | 24.91 | 25.15 | 0.67 |
...
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.48 |
| stomp_2 | STOMP | 0.00 | 4.40 | 4.64 | 0.95 |
| stomp_3_smooth | STOMP | 0.00 | 4.35 | 4.60 | 1.40 |
...
| stomp_1 | STOMP | 0.00 | 10.93 | 11.17 | 0.49 |
| stomp_2 | STOMP | 0.00 | 4.41 | 4.65 | 0.94 |
| stomp_3_smooth | STOMP | 0.00 | 4.36 | 4.60 | 1.39 |
